    ...
    <>
      ...
      >
        <div className="container mx-auto px-2 md:px-4">
          <div className="grid grid-cols-1 gap-3 py-8 md:grid-cols-2 md:gap-4">
            <Link href="/customer" className="block">
              <div className="mx-8 flex h-64 flex-col items-center rounded bg-black/70 p-1 text-white shadow transition duration-200 hover:scale-110 hover:bg-white md:h-64">
                <svg
                ...
                <p className="mt-1 text-center text-3xl md:mt-2">
      ...
      <footer className="flex h-12 shrink-0 items-center bg-black md:h-16">
        <div className="container mx-auto text-center text-sm text-white md:text-base">
